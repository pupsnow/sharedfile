package com.esri.ags.symbols.supportClasses
{
    ...
    public class PointXStyle extends PointSymbolStyle implements ISymbolStyle
    {

        public function PointXStyle()
        {
            return;
        }// end function
        ...
        override protected function drawStyleWithNoOutline(sprite:Sprite, point:MapPoint, screenX:Number, screenY:Number) : Rectangle
        {
            ...
            else
            {
                ...
                this.traceX(sprite.graphics, screenX, screenY, half);
            }
            return _loc_5;
        }// end function
        ...
        override protected function drawStyleWithStyledOutline(sprite:Sprite, point:MapPoint, screenX:Number, screenY:Number) : Rectangle
        {
            ...
            {
                _loc_6 = [[screenX - half, screenY + half, screenX + half, screenY - half], [screenX + half, screenY + half, screenX - half, screenY - half]];
        ...
        private function traceX(graphics:Graphics, screenX:Number, screenY:Number, half:Number) : void
        {
            graphics.moveTo(screenX - half, screenY + half);
            graphics.lineTo(screenX + half, screenY - half);
            graphics.moveTo(screenX + half, screenY + half);
            graphics.lineTo(screenX - half, screenY - half);
            return;
        }// end function
        ...
        private function traceRotationCross(sprite:Sprite, screenX:Number, screenY:Number, half:Number, isStyled:Boolean, stroke:SolidColorStroke) : Rectangle
        {
            ...
            new Vector.<Number>(8)[1] = screenY + half;
            new Vector.<Number>(8)[2] = screenX + half;
            new Vector.<Number>(8)[3] = screenY - half;
            new Vector.<Number>(8)[4] = screenX + half;
            new Vector.<Number>(8)[5] = screenY + half;
            new Vector.<Number>(8)[6] = screenX - half;
