package com.esri.ags.tasks.supportClasses
{
    ...
    public class FindResult extends EventDispatcher
    {
        ...
        {
            return this._388783427foundFieldName;
        }// end function

        public function set foundFieldName(value:String) : void
        {
            arguments = this._388783427foundFieldName;
            if (arguments !== value)
            {
                this._388783427foundFieldName = value;
                if (this.hasEventListener("propertyChange"))
                {
                    this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "foundFieldName", arguments, value));
                }
            }
            return;
        }// end function
        ...
        static function toFindResult(obj:Object) : FindResult
        {
            var _loc_2:FindResult = null;
            if (obj)
            {
                _loc_2 = new FindResult;
                _loc_2.layerId = obj.layerId;
                _loc_2.layerName = obj.layerName;
                _loc_2.displayFieldName = obj.displayFieldName;
                _loc_2.foundFieldName = obj.foundFieldName;
