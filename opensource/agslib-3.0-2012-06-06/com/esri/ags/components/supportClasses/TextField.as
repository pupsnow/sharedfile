package com.esri.ags.components.supportClasses
{
    ...
    public class TextField extends TextArea implements IDataRenderer
    {
        private var m_listenerAdded:Boolean = false;
        private var m_oldDataValue:Object;
        private static var _skinParts:Object = {promptDisplay:false, scroller:false, textDisplay:false};
        ...
        {
            if (this.getTargetAsTextField(event.target) !== this)
            {
                stage.focus = null;
                this.commitDataChange();
                FlexGlobals.topLevelApplication.removeEventListener(MouseEvent.MOUSE_DOWN, this.mouseDownHandler, true);
        ...
        private function getTargetAsTextField(target:Object) : TextField
        {
            var _loc_2:* = target as TextField;
            if (_loc_2)
            {
                return _loc_2;
            }
            if (target.parent)
            {
                return this.getTargetAsTextField(target.parent);
            }
            return null;
        }// end function
