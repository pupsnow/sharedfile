package com.esri.ags.skins
{
    ...
    public class NavigationVSliderSkin extends SparkSkin implements IBindingClient, IStateClient2
    {
        ...
        public function NavigationVSliderSkin()
        {
            var target:Object;
            ...
            var bindings:* = this._NavigationVSliderSkin_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_esri_ags_skins_NavigationVSliderSkinWatcherSetupUtil");
            ...
            {
                return NavigationVSliderSkin[propertyName];
            }// end function
            , bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.minWidth = 11;
            this.mxmlContent = [this._NavigationVSliderSkin_UIComponent1_i(), this._NavigationVSliderSkin_Button1_i(), this._NavigationVSliderSkin_Button2_i()];
            this.currentState = "normal";
            this._NavigationVSliderSkin_ClassFactory1_i();
        ...
        private function drawTicks() : void
        {
            ...
            if (_loc_2 > 0)
            {
                ...
                do
                {
                    ...
                    _loc_7 = Math.round(this.getYFromValue(_loc_8));
                    _loc_6.moveTo(0, _loc_7);
                    _loc_6.lineTo(_loc_3, _loc_7);
                    _loc_8 = _loc_2 + _loc_8;
                }while (_loc_8 < this.hostComponent.maximum)
                _loc_7 = Math.round(this.getMinY());
                _loc_6.moveTo(0, _loc_7);
                _loc_6.lineTo(_loc_3, _loc_7);
                this.ticks.width = _loc_3 - _loc_4;
            }
            return;
        }// end function
        ...
        private function getYFromValue(v:Number) : Number
        {
            ...
            var _loc_2:* = this.getMaxY();
            var _loc_3:* = this.getMinY();
        ...
        {
            return this.thumb.height / 2;
        }// end function

        private function getMaxY() : Number
        {
            return height - this.thumb.height / 2;
        }// end function

        private function _NavigationVSliderSkin_ClassFactory1_i() : ClassFactory
        {
            var _loc_1:* = new ClassFactory();
            _loc_1.generator = NavigationVSliderSkinInnerClass0;
        ...
        private function _NavigationVSliderSkin_UIComponent1_i() : UIComponent
        {
        ...
        private function _NavigationVSliderSkin_Button1_i() : Button
        {
            ...
            _loc_1.bottom = 0;
            _loc_1.minHeight = 33;
            _loc_1.setStyle("skinClass", VSliderTrackSkin);
            _loc_1.id = "track";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _NavigationVSliderSkin_Button2_i() : Button
        {
            var _loc_1:* = new Button();
            _loc_1.width = 11;
            _loc_1.height = 11;
            _loc_1.right = 0;
            _loc_1.setStyle("skinClass", VSliderThumbSkin);
            _loc_1.id = "thumb";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _NavigationVSliderSkin_bindingsSetup() : Array
        {
            var result:Array;
        ...
        public function set hostComponent(value:VSlider) : void
        {
        ...
        {
            NavigationVSliderSkin._watcherSetupUtil = watcherSetupUtil;
            return;
        }// end function
