package com.esri.ags.skins
{
    ...
    public class ContentNavigatorPreviousButtonSkin extends Skin implements IStateClient2
    {
        ...
        public function ContentNavigatorPreviousButtonSkin()
        {
            mx_internal::_document = this;
            this.width = 16;
            this.height = 16;
            this.mxmlContent = [this._ContentNavigatorPreviousButtonSkin_Rect1_c(), this._ContentNavigatorPreviousButtonSkin_Path1_c()];
        ...
        private function _ContentNavigatorPreviousButtonSkin_Rect1_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            _loc_1.top = 0;
            _loc_1.bottom = 0;
            _loc_1.stroke = this._ContentNavigatorPreviousButtonSkin_SolidColorStroke1_i();
            _loc_1.fill = this._ContentNavigatorPreviousButtonSkin_SolidColor1_i();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _ContentNavigatorPreviousButtonSkin_SolidColorStroke1_i() : SolidColorStroke
        {
        ...
        private function _ContentNavigatorPreviousButtonSkin_SolidColor1_i() : SolidColor
        {
        ...
        private function _ContentNavigatorPreviousButtonSkin_Path1_c() : Path
        {
            var _loc_1:* = new Path();
            _loc_1.fill = this._ContentNavigatorPreviousButtonSkin_SolidColor2_i();
            _loc_1.data = "M 3 8 L 13 3 L 13 13 Z";
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _ContentNavigatorPreviousButtonSkin_SolidColor2_i() : SolidColor
        {
            var _loc_1:* = new SolidColor();
