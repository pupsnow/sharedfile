package com.esri.ags.skins
{
    ...
    public class EditorDrawDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
    {
        public var _EditorDrawDropDownListSkin_SolidColorStroke1:SolidColorStroke;
        ...
        public function EditorDrawDropDownListSkin()
        {
            var target:Object;
            var watcherSetupUtilClass:Object;
            this._770043015m_embed = EditorDrawDropDownListSkin_m_embed;
            this._bindings = [];
            this._watchers = [];
            this._bindingsByDestination = {};
            this._bindingsBeginWithWord = {};
            mx_internal::_document = this;
            var bindings:* = this._EditorDrawDropDownListSkin_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_esri_ags_skins_EditorDrawDropDownListSkinWatcherSetupUtil");
            ...
            {
                return EditorDrawDropDownListSkin[propertyName];
            }// end function
            , bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.mxmlContent = [this._EditorDrawDropDownListSkin_Button1_i(), this._EditorDrawDropDownListSkin_BitmapImage1_i()];
            this.currentState = "normal";
            this.addEventListener("initialize", this.___EditorDrawDropDownListSkin_SparkSkin1_initialize);
            var _EditorDrawDropDownListSkin_PopUpAnchor1_factory:* = new DeferredInstanceFromFunction(this._EditorDrawDropDownListSkin_PopUpAnchor1_i, this._EditorDrawDropDownListSkin_PopUpAnchor1_r);
            states = [new State({name:"normal", overrides:[new SetProperty().initializeFromObject({target:"popUp", name:"displayPopUp", value:false})]}), new State({name:"open", overrides:[new AddItems().initializeFromObject({destructionPolicy:"auto", itemsFactory:_EditorDrawDropDownListSkin_PopUpAnchor1_factory, destination:null, propertyName:"mxmlContent", position:"first"}), new SetProperty().initializeFromObject({target:"popUp", name:"displayPopUp", value:true})]}), new State({name:"disabled", overrides:[new SetProperty().initializeFromObject({name:"alpha", value:0.3})]})];
            var i:uint;
        ...
        private function _EditorDrawDropDownListSkin_PopUpAnchor1_i() : PopUpAnchor
        {
            ...
            _loc_1.popUp = this._EditorDrawDropDownListSkin_Group1_i();
            _loc_1.id = "popUp";
            if (!_loc_1.document)
            {
        ...
        private function _EditorDrawDropDownListSkin_PopUpAnchor1_r() : void
        {
            ...
            this.border = null;
            var _loc_1:String = null;
            this._EditorDrawDropDownListSkin_SolidColorStroke1 = null;
            var _loc_1:String = null;
        ...
        private function _EditorDrawDropDownListSkin_Group1_i() : Group
        {
            var _loc_1:* = new Group();
            _loc_1.maxHeight = 134;
            _loc_1.minHeight = 22;
            _loc_1.mxmlContent = [this._EditorDrawDropDownListSkin_RectangularDropShadow1_i(), this._EditorDrawDropDownListSkin_Rect1_i(), this._EditorDrawDropDownListSkin_Rect2_i(), this._EditorDrawDropDownListSkin_Scroller1_i()];
            _loc_1.id = "dropDown";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _EditorDrawDropDownListSkin_RectangularDropShadow1_i() : RectangularDropShadow
        {
        ...
        private function _EditorDrawDropDownListSkin_Rect1_i() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            _loc_1.top = 0;
            _loc_1.bottom = 0;
            _loc_1.stroke = this._EditorDrawDropDownListSkin_SolidColorStroke1_i();
        ...
        private function _EditorDrawDropDownListSkin_SolidColorStroke1_i() : SolidColorStroke
        {
            var _loc_1:* = new SolidColorStroke();
            _loc_1.weight = 1;
            this._EditorDrawDropDownListSkin_SolidColorStroke1 = _loc_1;
            BindingManager.executeBindings(this, "_EditorDrawDropDownListSkin_SolidColorStroke1", this._EditorDrawDropDownListSkin_SolidColorStroke1);
            return _loc_1;
        }// end function

        private function _EditorDrawDropDownListSkin_Rect2_i() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            _loc_1.top = 1;
            _loc_1.bottom = 1;
            _loc_1.fill = this._EditorDrawDropDownListSkin_SolidColor1_i();
        ...
        private function _EditorDrawDropDownListSkin_SolidColor1_i() : SolidColor
        {
        ...
        private function _EditorDrawDropDownListSkin_Scroller1_i() : Scroller
        {
            ...
            _loc_1.viewport = this._EditorDrawDropDownListSkin_DataGroup1_i();
            _loc_1.id = "scroller";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _EditorDrawDropDownListSkin_DataGroup1_i() : DataGroup
        {
            var _loc_1:* = new DataGroup();
            _loc_1.itemRenderer = this._EditorDrawDropDownListSkin_ClassFactory1_c();
            _loc_1.layout = this._EditorDrawDropDownListSkin_VerticalLayout1_c();
            _loc_1.id = "dataGroup";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _EditorDrawDropDownListSkin_ClassFactory1_c() : ClassFactory
        {
        ...
        private function _EditorDrawDropDownListSkin_VerticalLayout1_c() : VerticalLayout
        {
        ...
        private function _EditorDrawDropDownListSkin_Button1_i() : Button
        {
        ...
        private function _EditorDrawDropDownListSkin_BitmapImage1_i() : BitmapImage
        {
        ...
        public function ___EditorDrawDropDownListSkin_SparkSkin1_initialize(event:FlexEvent) : void
        {
            this.dropDownListSkin_initializeHandler(event);
            return;
        }// end function

        private function _EditorDrawDropDownListSkin_bindingsSetup() : Array
        {
            var result:Array;
            ...
            , null, "_EditorDrawDropDownListSkin_SolidColorStroke1.alpha");
            result[1] = new Binding(this, function () : uint
            {
                return getStyle("borderColor");
            }// end function
            , null, "_EditorDrawDropDownListSkin_SolidColorStroke1.color");
        ...
        {
            EditorDrawDropDownListSkin._watcherSetupUtil = watcherSetupUtil;
            return;
        }// end function
